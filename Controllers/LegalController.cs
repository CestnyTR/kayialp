...
public class LegalController : Controller
{
    ...
    {
        var culture = (RouteData.Values["culture"]?.ToString() ?? "tr").ToLowerInvariant();
        ...
        var tr = await _context.LegalPageTranslations
            .AsNoTracking()
